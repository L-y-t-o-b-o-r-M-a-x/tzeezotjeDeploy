...
/* harmony import */ var _components_slider_gl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/slider-gl */ "./src/js/components/slider-gl.js");
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)('.forms-2', rules1, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)('.forms-1', rules1, afterForm);
...
//       zoom: 10,
//       center: { lat: 51.007146758087444, lng: 3.6234015124277246 },
//       zoomControl: false,
...
/***/ "./src/js/components/slider-gl.js":
/*!****************************************!*\
  !*** ./src/js/components/slider-gl.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
console.log(elList);
const swiperGallery = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](elList, {
  slidesPerView: "auto",
  // slidesPerView: 1,
  loop: true,
  centeredSlides: true,
...
const validateForms = (selector, rules, afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('+32 (9) 999-99-99');
